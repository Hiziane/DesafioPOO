...
public class Funcionario2{
	...
	public Funcionario2(int id, String nome, Date dataAdmissao, float salario) {
		this.id = id;
		this.nome = nome;
	...
	public Funcionario2(int id, String nome, Date dataAdmissao, float salario, Date desligamento) {
		this.id = id;
		this.nome = nome;
		this.dataAdmissao = dataAdmissao;
		this.salario = salario;
